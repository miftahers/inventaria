 ...
 * @author User
 */
public class Login_Inventaria extends javax.swing.JFrame {

    /**
     * Creates new form Login_Inventaria
     */
    public Login_Inventaria() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(689, 434));
        ...
        jButton1.setBackground(new java.awt.Color(255, 134, 47));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_Inventaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login_Inventaria().setVisible(true);
            }
        });
    }
